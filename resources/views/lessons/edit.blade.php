                            ...
                            <form action="{{ route('lesson.update', $lesson->id) }}" method="POST">
                                ...
                                <fieldset class="form-group p-3" style="border: 1px solid black;">
                                    ...
                                    <div class="form-group input-group">
                                        <input name="name" class="form-control" placeholder="Teacher's Name" value="{{ $lesson->name }}" type="text"
                                            required>
                                    </div>

                                    <div class="form-group input-group">
                                        <select class="form-control" name="class" required >
                                            <option selected="" value="{{ $lesson->class }}">Year {{ $lesson->class }}</option>
                                ...
                                <fieldset class="form-group p-3" style="border: 1px solid black;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment" class="form-control" id="editor" rows="5">{{ $lesson->comment }}</textarea>
                                    </div>

                                </fieldset>
                                
                                <div class="form-group">
                                    <button type="submit" class="btn btn-warning btn-block"> Update Observation </button>
                                </div> <!-- form-group// -->
                            </form>
                        </article>
                    </div>
